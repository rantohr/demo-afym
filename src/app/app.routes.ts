...
import { FacturationCreateComponent } from './pages/facturation/facturation-create/facturation-create.component';
...
export const routes: Routes = [
    ...
    { path: 'creation-facturation', component: FacturationCreateComponent },
];
